    ...
    <div className="pt-20 lg:pt-24 min-h-screen bg-slate-50">
      ...
      <section className="relative bg-[#0B152A] py-24 sm:py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            <Camera className="w-16 h-16 mx-auto text-[#D4AF37] mb-6 animate-pulse" />
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-serif font-black text-white mb-6">
              Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D4AF37] to-[#f8f0dd]">Gallery</span>
            </h1>
            <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
              Take a glimpse into the harmonious spaces we've created. Explore our journey of transforming environments.
            </p>
          </motion.div>
        </div>
      </section>
