    ...
    <section id="blog" className="py-24 bg-slate-50 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-12">
          <button className="inline-flex items-center gap-2 px-8 py-4 bg-transparent border-2 border-[#D4AF37] text-gray-900 font-bold rounded-full hover:bg-[#D4AF37] hover:text-white transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-1">
            View All Posts
          </button>
        </div>
